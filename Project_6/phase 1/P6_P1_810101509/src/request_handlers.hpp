...
public:
    LogoutRequestHandler(MusicApp* app);
    virtual CommandResponse callback(const CommandRequest& request) override;
};

class GetMusicsHandler : public CommandRequestHandler {
public:
    GetMusicsHandler(MusicApp* app);
    virtual CommandResponse callback(const CommandRequest& request) override;
...
public:
    CreatePlaylistHandler(MusicApp* app);
    virtual CommandResponse callback(const CommandRequest& request) override;
};

class AddSongToPlaylistHandler : public CommandRequestHandler {
public:
    AddSongToPlaylistHandler(MusicApp* app);
    virtual CommandResponse callback(const CommandRequest& request) override;
};

class GetUserPlaylistsHandler : public CommandRequestHandler {
public:
    GetUserPlaylistsHandler(MusicApp* app);
    virtual CommandResponse callback(const CommandRequest& request) override;
};

class SearchMusicHandler : public CommandRequestHandler {
public:
    SearchMusicHandler(MusicApp* app);
    virtual CommandResponse callback(const CommandRequest& request) override;
};

class CreateMusicHandler : public CommandRequestHandler {
public:
    CreateMusicHandler(MusicApp* app);
    virtual CommandResponse callback(const CommandRequest& request) override;
};

class RemoveMusicHandler : public CommandRequestHandler {
public:
    RemoveMusicHandler(MusicApp* app);
    virtual CommandResponse callback(const CommandRequest& request) override;
};

class GetArtistMusicsHandler : public CommandRequestHandler {
public:
    GetArtistMusicsHandler(MusicApp* app);
    virtual CommandResponse callback(const CommandRequest& request) override;
};

...
IoHandler::IoHandler(std::istream& input_stream, std::ostream& output_stream)
    ...
    cmds_ = {
        ...
        {consts::input::GET    + " " + consts::cmds::PLAYLIST,          new GetPlaylistHandler(app)},
        ...
        {consts::input::POST   + " " + consts::cmds::FOLLOW,            new FollowHandler(app)},
        {consts::input::POST   + " " + consts::cmds::UNFOLLOW,          new UnfollowHandler(app)},
        {consts::input::POST   + " " + consts::cmds::LIKE,              new LikeHandler(app)},
        {consts::input::GET    + " " + consts::cmds::LIKES,             new GetLikesHandler(app)},
        {consts::input::DELETE + " " + consts::cmds::PLAYLIST,          new DeletePlaylistHandler(app)},
        {consts::input::GET    + " " + consts::cmds::RECOMMENDATIONS,   new GetRecommendationsHandler(app)},
    };
    // clang-format on
}
